...
class QualiSerie extends StatefulWidget {
  const QualiSerie({Key? key}) : super(key: key);

  @override
  State<QualiSerie> createState() => _QualiSerieState();
}

class _QualiSerieState extends State<QualiSerie> {
  @override
